...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.BeezUPCommonPaginationResultLinks();
  });
  ...
  describe('BeezUPCommonPaginationResultLinks', function() {
    it('should create an instance of BeezUPCommonPaginationResultLinks', function() {
      // uncomment below and update the code to test BeezUPCommonPaginationResultLinks
      //var instane = new BeezUpApi.BeezUPCommonPaginationResultLinks();
      //expect(instance).to.be.a(BeezUpApi.BeezUPCommonPaginationResultLinks);
    });
