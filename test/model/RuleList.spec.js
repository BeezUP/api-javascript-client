...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.RuleList();
  });
  ...
  describe('RuleList', function() {
    it('should create an instance of RuleList', function() {
      // uncomment below and update the code to test RuleList
      //var instane = new BeezUpApi.RuleList();
      //expect(instance).to.be.a(BeezUpApi.RuleList);
    });
