...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.SetMerchantOrderInfoRequest();
  });
  ...
  describe('SetMerchantOrderInfoRequest', function() {
    it('should create an instance of SetMerchantOrderInfoRequest', function() {
      // uncomment below and update the code to test SetMerchantOrderInfoRequest
      //var instane = new BeezUpApi.SetMerchantOrderInfoRequest();
      //expect(instance).to.be.a(BeezUpApi.SetMerchantOrderInfoRequest);
    });
