...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.CreditCardInfoWithCardType();
  });
  ...
  describe('CreditCardInfoWithCardType', function() {
    it('should create an instance of CreditCardInfoWithCardType', function() {
      // uncomment below and update the code to test CreditCardInfoWithCardType
      //var instane = new BeezUpApi.CreditCardInfoWithCardType();
      //expect(instance).to.be.a(BeezUpApi.CreditCardInfoWithCardType);
    });
