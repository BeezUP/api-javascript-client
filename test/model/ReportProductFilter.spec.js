...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.ReportProductFilter();
  });
  ...
  describe('ReportProductFilter', function() {
    it('should create an instance of ReportProductFilter', function() {
      // uncomment below and update the code to test ReportProductFilter
      //var instane = new BeezUpApi.ReportProductFilter();
      //expect(instance).to.be.a(BeezUpApi.ReportProductFilter);
    });
