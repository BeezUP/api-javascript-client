...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.StoreShare();
  });
  ...
  describe('StoreShare', function() {
    it('should create an instance of StoreShare', function() {
      // uncomment below and update the code to test StoreShare
      //var instane = new BeezUpApi.StoreShare();
      //expect(instance).to.be.a(BeezUpApi.StoreShare);
    });
