...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.TerminateContract();
  });
  ...
  describe('TerminateContract', function() {
    it('should create an instance of TerminateContract', function() {
      // uncomment below and update the code to test TerminateContract
      //var instane = new BeezUpApi.TerminateContract();
      //expect(instance).to.be.a(BeezUpApi.TerminateContract);
    });
