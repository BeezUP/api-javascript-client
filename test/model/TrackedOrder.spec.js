...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.TrackedOrder();
  });
  ...
  describe('TrackedOrder', function() {
    it('should create an instance of TrackedOrder', function() {
      // uncomment below and update the code to test TrackedOrder
      //var instane = new BeezUpApi.TrackedOrder();
      //expect(instance).to.be.a(BeezUpApi.TrackedOrder);
    });
