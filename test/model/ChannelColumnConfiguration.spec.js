...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.ChannelColumnConfiguration();
  });
  ...
  describe('ChannelColumnConfiguration', function() {
    it('should create an instance of ChannelColumnConfiguration', function() {
      // uncomment below and update the code to test ChannelColumnConfiguration
      //var instane = new BeezUpApi.ChannelColumnConfiguration();
      //expect(instance).to.be.a(BeezUpApi.ChannelColumnConfiguration);
    });
