...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.BeezUPCommonLOVLink2();
  });
  ...
  describe('BeezUPCommonLOVLink2', function() {
    it('should create an instance of BeezUPCommonLOVLink2', function() {
      // uncomment below and update the code to test BeezUPCommonLOVLink2
      //var instane = new BeezUpApi.BeezUPCommonLOVLink2();
      //expect(instance).to.be.a(BeezUpApi.BeezUPCommonLOVLink2);
    });
