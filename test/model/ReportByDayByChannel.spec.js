...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.ReportByDayByChannel();
  });
  ...
  describe('ReportByDayByChannel', function() {
    it('should create an instance of ReportByDayByChannel', function() {
      // uncomment below and update the code to test ReportByDayByChannel
      //var instane = new BeezUpApi.ReportByDayByChannel();
      //expect(instance).to.be.a(BeezUpApi.ReportByDayByChannel);
    });
