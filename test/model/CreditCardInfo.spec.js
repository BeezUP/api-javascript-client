...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.CreditCardInfo();
  });
  ...
  describe('CreditCardInfo', function() {
    it('should create an instance of CreditCardInfo', function() {
      // uncomment below and update the code to test CreditCardInfo
      //var instane = new BeezUpApi.CreditCardInfo();
      //expect(instance).to.be.a(BeezUpApi.CreditCardInfo);
    });
