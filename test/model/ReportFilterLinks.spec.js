...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.ReportFilterLinks();
  });
  ...
  describe('ReportFilterLinks', function() {
    it('should create an instance of ReportFilterLinks', function() {
      // uncomment below and update the code to test ReportFilterLinks
      //var instane = new BeezUpApi.ReportFilterLinks();
      //expect(instance).to.be.a(BeezUpApi.ReportFilterLinks);
    });
