...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.RegisterRequest();
  });
  ...
  describe('RegisterRequest', function() {
    it('should create an instance of RegisterRequest', function() {
      ...
      //var instane = new BeezUpApi.RegisterRequest();
      //expect(instance).to.be.a(BeezUpApi.RegisterRequest);
    });
    ...
    it('should have the property commercialOwnerUserId (base name: "commercialOwnerUserId")', function() {
      // uncomment below and update the code to test the property commercialOwnerUserId
      //var instane = new BeezUpApi.RegisterRequest();
      //expect(instance).to.be();
    });
