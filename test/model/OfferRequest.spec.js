...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.OfferRequest();
  });
  ...
  describe('OfferRequest', function() {
    it('should create an instance of OfferRequest', function() {
      // uncomment below and update the code to test OfferRequest
      //var instane = new BeezUpApi.OfferRequest();
      //expect(instance).to.be.a(BeezUpApi.OfferRequest);
    });
