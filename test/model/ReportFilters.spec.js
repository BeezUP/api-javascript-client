...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.ReportFilters();
  });
  ...
  describe('ReportFilters', function() {
    it('should create an instance of ReportFilters', function() {
      // uncomment below and update the code to test ReportFilters
      //var instane = new BeezUpApi.ReportFilters();
      //expect(instance).to.be.a(BeezUpApi.ReportFilters);
    });
