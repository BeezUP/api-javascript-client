...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BeezUpApi.ReportByDayAllChannels();
  });
  ...
  describe('ReportByDayAllChannels', function() {
    it('should create an instance of ReportByDayAllChannels', function() {
      // uncomment below and update the code to test ReportByDayAllChannels
      //var instane = new BeezUpApi.ReportByDayAllChannels();
      //expect(instance).to.be.a(BeezUpApi.ReportByDayAllChannels);
    });
