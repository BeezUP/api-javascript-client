...
(function(root, factory) {
  ...
  /**
   * The LinksDeleteChannelCatalogExportationCacheLink model module.
   * @module model/LinksDeleteChannelCatalogExportationCacheLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksDeleteChannelCatalogExportationCacheLink</code>.
   * @alias module:model/LinksDeleteChannelCatalogExportationCacheLink
   * @class
  ...
  /**
   * Constructs a <code>LinksDeleteChannelCatalogExportationCacheLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksDeleteChannelCatalogExportationCacheLink} obj Optional instance to populate.
   * @return {module:model/LinksDeleteChannelCatalogExportationCacheLink} The populated <code>LinksDeleteChannelCatalogExportationCacheLink</code> instance.
   */
