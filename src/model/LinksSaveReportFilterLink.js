...
(function(root, factory) {
  ...
  /**
   * The LinksSaveReportFilterLink model module.
   * @module model/LinksSaveReportFilterLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksSaveReportFilterLink</code>.
   * @alias module:model/LinksSaveReportFilterLink
   * @class
  ...
  /**
   * Constructs a <code>LinksSaveReportFilterLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksSaveReportFilterLink} obj Optional instance to populate.
   * @return {module:model/LinksSaveReportFilterLink} The populated <code>LinksSaveReportFilterLink</code> instance.
   */
