...
(function(root, factory) {
  ...
  /**
   * The LinksChangeOrderLink model module.
   * @module model/LinksChangeOrderLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksChangeOrderLink</code>.
   * @alias module:model/LinksChangeOrderLink
   * @class
  ...
  /**
   * Constructs a <code>LinksChangeOrderLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksChangeOrderLink} obj Optional instance to populate.
   * @return {module:model/LinksChangeOrderLink} The populated <code>LinksChangeOrderLink</code> instance.
   */
