...
(function(root, factory) {
  ...
  /**
   * The LinksOptimiseByCategoryLink model module.
   * @module model/LinksOptimiseByCategoryLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksOptimiseByCategoryLink</code>.
   * @alias module:model/LinksOptimiseByCategoryLink
   * @class
  ...
  /**
   * Constructs a <code>LinksOptimiseByCategoryLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksOptimiseByCategoryLink} obj Optional instance to populate.
   * @return {module:model/LinksOptimiseByCategoryLink} The populated <code>LinksOptimiseByCategoryLink</code> instance.
   */
