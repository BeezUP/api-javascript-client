...
(function(root, factory) {
  ...
  /**
   * The LinksGetReportFilterLink model module.
   * @module model/LinksGetReportFilterLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetReportFilterLink</code>.
   * @alias module:model/LinksGetReportFilterLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetReportFilterLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetReportFilterLink} obj Optional instance to populate.
   * @return {module:model/LinksGetReportFilterLink} The populated <code>LinksGetReportFilterLink</code> instance.
   */
