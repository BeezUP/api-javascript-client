...
(function(root, factory) {
  ...
  /**
   * The LinksChangePasswordLink model module.
   * @module model/LinksChangePasswordLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksChangePasswordLink</code>.
   * @alias module:model/LinksChangePasswordLink
   * @class
  ...
  /**
   * Constructs a <code>LinksChangePasswordLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksChangePasswordLink} obj Optional instance to populate.
   * @return {module:model/LinksChangePasswordLink} The populated <code>LinksChangePasswordLink</code> instance.
   */
