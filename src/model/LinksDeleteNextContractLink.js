...
(function(root, factory) {
  ...
  /**
   * The LinksDeleteNextContractLink model module.
   * @module model/LinksDeleteNextContractLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksDeleteNextContractLink</code>.
   * @alias module:model/LinksDeleteNextContractLink
   * @class
  ...
  /**
   * Constructs a <code>LinksDeleteNextContractLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksDeleteNextContractLink} obj Optional instance to populate.
   * @return {module:model/LinksDeleteNextContractLink} The populated <code>LinksDeleteNextContractLink</code> instance.
   */
