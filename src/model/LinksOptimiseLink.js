...
(function(root, factory) {
  ...
  /**
   * The LinksOptimiseLink model module.
   * @module model/LinksOptimiseLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksOptimiseLink</code>.
   * @alias module:model/LinksOptimiseLink
   * @class
  ...
  /**
   * Constructs a <code>LinksOptimiseLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksOptimiseLink} obj Optional instance to populate.
   * @return {module:model/LinksOptimiseLink} The populated <code>LinksOptimiseLink</code> instance.
   */
