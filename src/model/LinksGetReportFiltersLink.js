...
(function(root, factory) {
  ...
  /**
   * The LinksGetReportFiltersLink model module.
   * @module model/LinksGetReportFiltersLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetReportFiltersLink</code>.
   * @alias module:model/LinksGetReportFiltersLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetReportFiltersLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetReportFiltersLink} obj Optional instance to populate.
   * @return {module:model/LinksGetReportFiltersLink} The populated <code>LinksGetReportFiltersLink</code> instance.
   */
