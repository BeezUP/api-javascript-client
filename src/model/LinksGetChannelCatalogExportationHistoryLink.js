...
(function(root, factory) {
  ...
  /**
   * The LinksGetChannelCatalogExportationHistoryLink model module.
   * @module model/LinksGetChannelCatalogExportationHistoryLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetChannelCatalogExportationHistoryLink</code>.
   * @alias module:model/LinksGetChannelCatalogExportationHistoryLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetChannelCatalogExportationHistoryLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetChannelCatalogExportationHistoryLink} obj Optional instance to populate.
   * @return {module:model/LinksGetChannelCatalogExportationHistoryLink} The populated <code>LinksGetChannelCatalogExportationHistoryLink</code> instance.
   */
