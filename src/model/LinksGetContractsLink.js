...
(function(root, factory) {
  ...
  /**
   * The LinksGetContractsLink model module.
   * @module model/LinksGetContractsLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetContractsLink</code>.
   * @alias module:model/LinksGetContractsLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetContractsLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetContractsLink} obj Optional instance to populate.
   * @return {module:model/LinksGetContractsLink} The populated <code>LinksGetContractsLink</code> instance.
   */
