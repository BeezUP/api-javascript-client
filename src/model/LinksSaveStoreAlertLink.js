...
(function(root, factory) {
  ...
  /**
   * The LinksSaveStoreAlertLink model module.
   * @module model/LinksSaveStoreAlertLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksSaveStoreAlertLink</code>.
   * @alias module:model/LinksSaveStoreAlertLink
   * @class
  ...
  /**
   * Constructs a <code>LinksSaveStoreAlertLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksSaveStoreAlertLink} obj Optional instance to populate.
   * @return {module:model/LinksSaveStoreAlertLink} The populated <code>LinksSaveStoreAlertLink</code> instance.
   */
