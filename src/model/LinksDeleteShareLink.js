...
(function(root, factory) {
  ...
  /**
   * The LinksDeleteShareLink model module.
   * @module model/LinksDeleteShareLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksDeleteShareLink</code>.
   * @alias module:model/LinksDeleteShareLink
   * @class
  ...
  /**
   * Constructs a <code>LinksDeleteShareLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksDeleteShareLink} obj Optional instance to populate.
   * @return {module:model/LinksDeleteShareLink} The populated <code>LinksDeleteShareLink</code> instance.
   */
