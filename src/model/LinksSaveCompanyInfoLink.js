...
(function(root, factory) {
  ...
  /**
   * The LinksSaveCompanyInfoLink model module.
   * @module model/LinksSaveCompanyInfoLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksSaveCompanyInfoLink</code>.
   * @alias module:model/LinksSaveCompanyInfoLink
   * @class
  ...
  /**
   * Constructs a <code>LinksSaveCompanyInfoLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksSaveCompanyInfoLink} obj Optional instance to populate.
   * @return {module:model/LinksSaveCompanyInfoLink} The populated <code>LinksSaveCompanyInfoLink</code> instance.
   */
