...
(function(root, factory) {
  ...
  /**
   * The LinksRunRulesLink model module.
   * @module model/LinksRunRulesLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksRunRulesLink</code>.
   * @alias module:model/LinksRunRulesLink
   * @class
  ...
  /**
   * Constructs a <code>LinksRunRulesLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksRunRulesLink} obj Optional instance to populate.
   * @return {module:model/LinksRunRulesLink} The populated <code>LinksRunRulesLink</code> instance.
   */
