...
(function(root, factory) {
  ...
  /**
   * The LinksImportationGetImportationMonitoringLink model module.
   * @module model/LinksImportationGetImportationMonitoringLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksImportationGetImportationMonitoringLink</code>.
   * @alias module:model/LinksImportationGetImportationMonitoringLink
   * @class
  ...
  /**
   * Constructs a <code>LinksImportationGetImportationMonitoringLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksImportationGetImportationMonitoringLink} obj Optional instance to populate.
   * @return {module:model/LinksImportationGetImportationMonitoringLink} The populated <code>LinksImportationGetImportationMonitoringLink</code> instance.
   */
