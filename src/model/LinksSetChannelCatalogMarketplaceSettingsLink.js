...
(function(root, factory) {
  ...
  /**
   * The LinksSetChannelCatalogMarketplaceSettingsLink model module.
   * @module model/LinksSetChannelCatalogMarketplaceSettingsLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksSetChannelCatalogMarketplaceSettingsLink</code>.
   * @alias module:model/LinksSetChannelCatalogMarketplaceSettingsLink
   * @class
  ...
  /**
   * Constructs a <code>LinksSetChannelCatalogMarketplaceSettingsLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksSetChannelCatalogMarketplaceSettingsLink} obj Optional instance to populate.
   * @return {module:model/LinksSetChannelCatalogMarketplaceSettingsLink} The populated <code>LinksSetChannelCatalogMarketplaceSettingsLink</code> instance.
   */
