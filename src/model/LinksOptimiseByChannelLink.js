...
(function(root, factory) {
  ...
  /**
   * The LinksOptimiseByChannelLink model module.
   * @module model/LinksOptimiseByChannelLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksOptimiseByChannelLink</code>.
   * @alias module:model/LinksOptimiseByChannelLink
   * @class
  ...
  /**
   * Constructs a <code>LinksOptimiseByChannelLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksOptimiseByChannelLink} obj Optional instance to populate.
   * @return {module:model/LinksOptimiseByChannelLink} The populated <code>LinksOptimiseByChannelLink</code> instance.
   */
