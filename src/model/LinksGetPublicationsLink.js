...
(function(root, factory) {
  ...
  /**
   * The LinksGetPublicationsLink model module.
   * @module model/LinksGetPublicationsLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetPublicationsLink</code>.
   * @alias module:model/LinksGetPublicationsLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetPublicationsLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetPublicationsLink} obj Optional instance to populate.
   * @return {module:model/LinksGetPublicationsLink} The populated <code>LinksGetPublicationsLink</code> instance.
   */
