...
(function(root, factory) {
  ...
  /**
   * The LinksHarvestOrderLink model module.
   * @module model/LinksHarvestOrderLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksHarvestOrderLink</code>.
   * @alias module:model/LinksHarvestOrderLink
   * @class
  ...
  /**
   * Constructs a <code>LinksHarvestOrderLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksHarvestOrderLink} obj Optional instance to populate.
   * @return {module:model/LinksHarvestOrderLink} The populated <code>LinksHarvestOrderLink</code> instance.
   */
