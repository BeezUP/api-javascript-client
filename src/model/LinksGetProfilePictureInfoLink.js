...
(function(root, factory) {
  ...
  /**
   * The LinksGetProfilePictureInfoLink model module.
   * @module model/LinksGetProfilePictureInfoLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetProfilePictureInfoLink</code>.
   * @alias module:model/LinksGetProfilePictureInfoLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetProfilePictureInfoLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetProfilePictureInfoLink} obj Optional instance to populate.
   * @return {module:model/LinksGetProfilePictureInfoLink} The populated <code>LinksGetProfilePictureInfoLink</code> instance.
   */
