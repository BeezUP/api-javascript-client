...
(function(root, factory) {
  ...
  /**
   * The LinksEnableRuleLink model module.
   * @module model/LinksEnableRuleLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksEnableRuleLink</code>.
   * @alias module:model/LinksEnableRuleLink
   * @class
  ...
  /**
   * Constructs a <code>LinksEnableRuleLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksEnableRuleLink} obj Optional instance to populate.
   * @return {module:model/LinksEnableRuleLink} The populated <code>LinksEnableRuleLink</code> instance.
   */
