...
(function(root, factory) {
  ...
  /**
   * The LinksCreateStoreLink model module.
   * @module model/LinksCreateStoreLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksCreateStoreLink</code>.
   * @alias module:model/LinksCreateStoreLink
   * @class
  ...
  /**
   * Constructs a <code>LinksCreateStoreLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksCreateStoreLink} obj Optional instance to populate.
   * @return {module:model/LinksCreateStoreLink} The populated <code>LinksCreateStoreLink</code> instance.
   */
