...
(function(root, factory) {
  ...
  /**
   * The LinksDisableRuleLink model module.
   * @module model/LinksDisableRuleLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksDisableRuleLink</code>.
   * @alias module:model/LinksDisableRuleLink
   * @class
  ...
  /**
   * Constructs a <code>LinksDisableRuleLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksDisableRuleLink} obj Optional instance to populate.
   * @return {module:model/LinksDisableRuleLink} The populated <code>LinksDisableRuleLink</code> instance.
   */
