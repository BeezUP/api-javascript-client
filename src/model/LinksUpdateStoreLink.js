...
(function(root, factory) {
  ...
  /**
   * The LinksUpdateStoreLink model module.
   * @module model/LinksUpdateStoreLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksUpdateStoreLink</code>.
   * @alias module:model/LinksUpdateStoreLink
   * @class
  ...
  /**
   * Constructs a <code>LinksUpdateStoreLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksUpdateStoreLink} obj Optional instance to populate.
   * @return {module:model/LinksUpdateStoreLink} The populated <code>LinksUpdateStoreLink</code> instance.
   */
