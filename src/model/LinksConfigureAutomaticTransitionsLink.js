...
(function(root, factory) {
  ...
  /**
   * The LinksConfigureAutomaticTransitionsLink model module.
   * @module model/LinksConfigureAutomaticTransitionsLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksConfigureAutomaticTransitionsLink</code>.
   * @alias module:model/LinksConfigureAutomaticTransitionsLink
   * @class
  ...
  /**
   * Constructs a <code>LinksConfigureAutomaticTransitionsLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksConfigureAutomaticTransitionsLink} obj Optional instance to populate.
   * @return {module:model/LinksConfigureAutomaticTransitionsLink} The populated <code>LinksConfigureAutomaticTransitionsLink</code> instance.
   */
