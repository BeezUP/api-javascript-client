...
(function(root, factory) {
  ...
  /**
   * The LinksGetPublicLovIndexLink model module.
   * @module model/LinksGetPublicLovIndexLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetPublicLovIndexLink</code>.
   * @alias module:model/LinksGetPublicLovIndexLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetPublicLovIndexLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetPublicLovIndexLink} obj Optional instance to populate.
   * @return {module:model/LinksGetPublicLovIndexLink} The populated <code>LinksGetPublicLovIndexLink</code> instance.
   */
