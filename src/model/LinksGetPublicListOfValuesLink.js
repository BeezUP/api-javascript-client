...
(function(root, factory) {
  ...
  /**
   * The LinksGetPublicListOfValuesLink model module.
   * @module model/LinksGetPublicListOfValuesLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetPublicListOfValuesLink</code>.
   * @alias module:model/LinksGetPublicListOfValuesLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetPublicListOfValuesLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetPublicListOfValuesLink} obj Optional instance to populate.
   * @return {module:model/LinksGetPublicListOfValuesLink} The populated <code>LinksGetPublicListOfValuesLink</code> instance.
   */
