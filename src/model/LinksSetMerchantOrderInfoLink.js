...
(function(root, factory) {
  ...
  /**
   * The LinksSetMerchantOrderInfoLink model module.
   * @module model/LinksSetMerchantOrderInfoLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksSetMerchantOrderInfoLink</code>.
   * @alias module:model/LinksSetMerchantOrderInfoLink
   * @class
  ...
  /**
   * Constructs a <code>LinksSetMerchantOrderInfoLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksSetMerchantOrderInfoLink} obj Optional instance to populate.
   * @return {module:model/LinksSetMerchantOrderInfoLink} The populated <code>LinksSetMerchantOrderInfoLink</code> instance.
   */
