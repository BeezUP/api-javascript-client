...
(function(root, factory) {
  ...
  /**
   * The LinksTerminateCurrentContractLink model module.
   * @module model/LinksTerminateCurrentContractLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksTerminateCurrentContractLink</code>.
   * @alias module:model/LinksTerminateCurrentContractLink
   * @class
  ...
  /**
   * Constructs a <code>LinksTerminateCurrentContractLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksTerminateCurrentContractLink} obj Optional instance to populate.
   * @return {module:model/LinksTerminateCurrentContractLink} The populated <code>LinksTerminateCurrentContractLink</code> instance.
   */
