...
(function(root, factory) {
  ...
  /**
   * The LinksGetOrderListLightLink model module.
   * @module model/LinksGetOrderListLightLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetOrderListLightLink</code>.
   * @alias module:model/LinksGetOrderListLightLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetOrderListLightLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetOrderListLightLink} obj Optional instance to populate.
   * @return {module:model/LinksGetOrderListLightLink} The populated <code>LinksGetOrderListLightLink</code> instance.
   */
