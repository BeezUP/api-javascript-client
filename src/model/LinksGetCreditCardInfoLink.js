...
(function(root, factory) {
  ...
  /**
   * The LinksGetCreditCardInfoLink model module.
   * @module model/LinksGetCreditCardInfoLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetCreditCardInfoLink</code>.
   * @alias module:model/LinksGetCreditCardInfoLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetCreditCardInfoLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetCreditCardInfoLink} obj Optional instance to populate.
   * @return {module:model/LinksGetCreditCardInfoLink} The populated <code>LinksGetCreditCardInfoLink</code> instance.
   */
