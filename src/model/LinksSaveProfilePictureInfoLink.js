...
(function(root, factory) {
  ...
  /**
   * The LinksSaveProfilePictureInfoLink model module.
   * @module model/LinksSaveProfilePictureInfoLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksSaveProfilePictureInfoLink</code>.
   * @alias module:model/LinksSaveProfilePictureInfoLink
   * @class
  ...
  /**
   * Constructs a <code>LinksSaveProfilePictureInfoLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksSaveProfilePictureInfoLink} obj Optional instance to populate.
   * @return {module:model/LinksSaveProfilePictureInfoLink} The populated <code>LinksSaveProfilePictureInfoLink</code> instance.
   */
