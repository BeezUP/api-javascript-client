...
(function(root, factory) {
  ...
  /**
   * The LinksMoveUpRuleLink model module.
   * @module model/LinksMoveUpRuleLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksMoveUpRuleLink</code>.
   * @alias module:model/LinksMoveUpRuleLink
   * @class
  ...
  /**
   * Constructs a <code>LinksMoveUpRuleLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksMoveUpRuleLink} obj Optional instance to populate.
   * @return {module:model/LinksMoveUpRuleLink} The populated <code>LinksMoveUpRuleLink</code> instance.
   */
