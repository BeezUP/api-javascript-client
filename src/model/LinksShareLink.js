...
(function(root, factory) {
  ...
  /**
   * The LinksShareLink model module.
   * @module model/LinksShareLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksShareLink</code>.
   * @alias module:model/LinksShareLink
   * @class
  ...
  /**
   * Constructs a <code>LinksShareLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksShareLink} obj Optional instance to populate.
   * @return {module:model/LinksShareLink} The populated <code>LinksShareLink</code> instance.
   */
