...
(function(root, factory) {
  ...
  /**
   * The LinksSetMerchantOrderInfoListLink model module.
   * @module model/LinksSetMerchantOrderInfoListLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksSetMerchantOrderInfoListLink</code>.
   * @alias module:model/LinksSetMerchantOrderInfoListLink
   * @class
  ...
  /**
   * Constructs a <code>LinksSetMerchantOrderInfoListLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksSetMerchantOrderInfoListLink} obj Optional instance to populate.
   * @return {module:model/LinksSetMerchantOrderInfoListLink} The populated <code>LinksSetMerchantOrderInfoListLink</code> instance.
   */
