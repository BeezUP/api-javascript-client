...
(function(root, factory) {
  ...
  /**
   * The LinksGetOrderExportationsLink model module.
   * @module model/LinksGetOrderExportationsLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetOrderExportationsLink</code>.
   * @alias module:model/LinksGetOrderExportationsLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetOrderExportationsLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetOrderExportationsLink} obj Optional instance to populate.
   * @return {module:model/LinksGetOrderExportationsLink} The populated <code>LinksGetOrderExportationsLink</code> instance.
   */
