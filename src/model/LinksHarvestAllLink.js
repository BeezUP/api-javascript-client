...
(function(root, factory) {
  ...
  /**
   * The LinksHarvestAllLink model module.
   * @module model/LinksHarvestAllLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksHarvestAllLink</code>.
   * @alias module:model/LinksHarvestAllLink
   * @class
  ...
  /**
   * Constructs a <code>LinksHarvestAllLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksHarvestAllLink} obj Optional instance to populate.
   * @return {module:model/LinksHarvestAllLink} The populated <code>LinksHarvestAllLink</code> instance.
   */
