...
(function(root, factory) {
  ...
  /**
   * The LinksGetUserListOfValuesLink model module.
   * @module model/LinksGetUserListOfValuesLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetUserListOfValuesLink</code>.
   * @alias module:model/LinksGetUserListOfValuesLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetUserListOfValuesLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetUserListOfValuesLink} obj Optional instance to populate.
   * @return {module:model/LinksGetUserListOfValuesLink} The populated <code>LinksGetUserListOfValuesLink</code> instance.
   */
