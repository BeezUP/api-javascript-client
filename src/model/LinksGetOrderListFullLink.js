...
(function(root, factory) {
  ...
  /**
   * The LinksGetOrderListFullLink model module.
   * @module model/LinksGetOrderListFullLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetOrderListFullLink</code>.
   * @alias module:model/LinksGetOrderListFullLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetOrderListFullLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetOrderListFullLink} obj Optional instance to populate.
   * @return {module:model/LinksGetOrderListFullLink} The populated <code>LinksGetOrderListFullLink</code> instance.
   */
