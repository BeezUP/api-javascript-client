...
(function(root, factory) {
  ...
  /**
   * The LinksMoveDownRuleLink model module.
   * @module model/LinksMoveDownRuleLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksMoveDownRuleLink</code>.
   * @alias module:model/LinksMoveDownRuleLink
   * @class
  ...
  /**
   * Constructs a <code>LinksMoveDownRuleLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksMoveDownRuleLink} obj Optional instance to populate.
   * @return {module:model/LinksMoveDownRuleLink} The populated <code>LinksMoveDownRuleLink</code> instance.
   */
