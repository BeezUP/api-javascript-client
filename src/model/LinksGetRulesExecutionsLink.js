...
(function(root, factory) {
  ...
  /**
   * The LinksGetRulesExecutionsLink model module.
   * @module model/LinksGetRulesExecutionsLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetRulesExecutionsLink</code>.
   * @alias module:model/LinksGetRulesExecutionsLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetRulesExecutionsLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetRulesExecutionsLink} obj Optional instance to populate.
   * @return {module:model/LinksGetRulesExecutionsLink} The populated <code>LinksGetRulesExecutionsLink</code> instance.
   */
