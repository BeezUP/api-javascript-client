...
(function(root, factory) {
  ...
  /**
   * The LinksGetRuleLink model module.
   * @module model/LinksGetRuleLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetRuleLink</code>.
   * @alias module:model/LinksGetRuleLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetRuleLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetRuleLink} obj Optional instance to populate.
   * @return {module:model/LinksGetRuleLink} The populated <code>LinksGetRuleLink</code> instance.
   */
