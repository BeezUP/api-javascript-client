...
(function(root, factory) {
  ...
  /**
   * The LinksGetMarketplaceAccountStoresLink model module.
   * @module model/LinksGetMarketplaceAccountStoresLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetMarketplaceAccountStoresLink</code>.
   * @alias module:model/LinksGetMarketplaceAccountStoresLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetMarketplaceAccountStoresLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetMarketplaceAccountStoresLink} obj Optional instance to populate.
   * @return {module:model/LinksGetMarketplaceAccountStoresLink} The populated <code>LinksGetMarketplaceAccountStoresLink</code> instance.
   */
