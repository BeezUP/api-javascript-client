...
(function(root, factory) {
  ...
  /**
   * The LinksGetAutomaticTransitionsLink model module.
   * @module model/LinksGetAutomaticTransitionsLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetAutomaticTransitionsLink</code>.
   * @alias module:model/LinksGetAutomaticTransitionsLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetAutomaticTransitionsLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetAutomaticTransitionsLink} obj Optional instance to populate.
   * @return {module:model/LinksGetAutomaticTransitionsLink} The populated <code>LinksGetAutomaticTransitionsLink</code> instance.
   */
