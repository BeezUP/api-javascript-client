...
(function(root, factory) {
  ...
  /**
   * The LinksGetChannelCatalogProductInfoLink model module.
   * @module model/LinksGetChannelCatalogProductInfoLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetChannelCatalogProductInfoLink</code>.
   * @alias module:model/LinksGetChannelCatalogProductInfoLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetChannelCatalogProductInfoLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetChannelCatalogProductInfoLink} obj Optional instance to populate.
   * @return {module:model/LinksGetChannelCatalogProductInfoLink} The populated <code>LinksGetChannelCatalogProductInfoLink</code> instance.
   */
