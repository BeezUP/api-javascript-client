...
(function(root, factory) {
  ...
  /**
   * The LinksOptimiseByProductLink model module.
   * @module model/LinksOptimiseByProductLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksOptimiseByProductLink</code>.
   * @alias module:model/LinksOptimiseByProductLink
   * @class
  ...
  /**
   * Constructs a <code>LinksOptimiseByProductLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksOptimiseByProductLink} obj Optional instance to populate.
   * @return {module:model/LinksOptimiseByProductLink} The populated <code>LinksOptimiseByProductLink</code> instance.
   */
