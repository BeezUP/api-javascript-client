...
(function(root, factory) {
  ...
  /**
   * The LinksGetStoreLink model module.
   * @module model/LinksGetStoreLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetStoreLink</code>.
   * @alias module:model/LinksGetStoreLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetStoreLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetStoreLink} obj Optional instance to populate.
   * @return {module:model/LinksGetStoreLink} The populated <code>LinksGetStoreLink</code> instance.
   */
