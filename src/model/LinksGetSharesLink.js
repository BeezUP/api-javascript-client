...
(function(root, factory) {
  ...
  /**
   * The LinksGetSharesLink model module.
   * @module model/LinksGetSharesLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetSharesLink</code>.
   * @alias module:model/LinksGetSharesLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetSharesLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetSharesLink} obj Optional instance to populate.
   * @return {module:model/LinksGetSharesLink} The populated <code>LinksGetSharesLink</code> instance.
   */
