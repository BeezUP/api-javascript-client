...
(function(root, factory) {
  ...
  /**
   * The LinksGetChannelCatalogExportationCacheInfoLink model module.
   * @module model/LinksGetChannelCatalogExportationCacheInfoLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetChannelCatalogExportationCacheInfoLink</code>.
   * @alias module:model/LinksGetChannelCatalogExportationCacheInfoLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetChannelCatalogExportationCacheInfoLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetChannelCatalogExportationCacheInfoLink} obj Optional instance to populate.
   * @return {module:model/LinksGetChannelCatalogExportationCacheInfoLink} The populated <code>LinksGetChannelCatalogExportationCacheInfoLink</code> instance.
   */
