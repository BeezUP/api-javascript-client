...
(function(root, factory) {
  ...
  /**
   * The LinksGetRulesLink model module.
   * @module model/LinksGetRulesLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetRulesLink</code>.
   * @alias module:model/LinksGetRulesLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetRulesLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetRulesLink} obj Optional instance to populate.
   * @return {module:model/LinksGetRulesLink} The populated <code>LinksGetRulesLink</code> instance.
   */
