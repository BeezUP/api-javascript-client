...
(function(root, factory) {
  ...
  /**
   * The LinksGetOrderLink model module.
   * @module model/LinksGetOrderLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetOrderLink</code>.
   * @alias module:model/LinksGetOrderLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetOrderLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetOrderLink} obj Optional instance to populate.
   * @return {module:model/LinksGetOrderLink} The populated <code>LinksGetOrderLink</code> instance.
   */
