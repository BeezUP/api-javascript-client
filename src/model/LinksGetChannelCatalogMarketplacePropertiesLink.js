...
(function(root, factory) {
  ...
  /**
   * The LinksGetChannelCatalogMarketplacePropertiesLink model module.
   * @module model/LinksGetChannelCatalogMarketplacePropertiesLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetChannelCatalogMarketplacePropertiesLink</code>.
   * @alias module:model/LinksGetChannelCatalogMarketplacePropertiesLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetChannelCatalogMarketplacePropertiesLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetChannelCatalogMarketplacePropertiesLink} obj Optional instance to populate.
   * @return {module:model/LinksGetChannelCatalogMarketplacePropertiesLink} The populated <code>LinksGetChannelCatalogMarketplacePropertiesLink</code> instance.
   */
