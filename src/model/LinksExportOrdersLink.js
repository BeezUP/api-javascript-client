...
(function(root, factory) {
  ...
  /**
   * The LinksExportOrdersLink model module.
   * @module model/LinksExportOrdersLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksExportOrdersLink</code>.
   * @alias module:model/LinksExportOrdersLink
   * @class
  ...
  /**
   * Constructs a <code>LinksExportOrdersLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksExportOrdersLink} obj Optional instance to populate.
   * @return {module:model/LinksExportOrdersLink} The populated <code>LinksExportOrdersLink</code> instance.
   */
