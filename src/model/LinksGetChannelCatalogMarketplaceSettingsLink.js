...
(function(root, factory) {
  ...
  /**
   * The LinksGetChannelCatalogMarketplaceSettingsLink model module.
   * @module model/LinksGetChannelCatalogMarketplaceSettingsLink
   * @version 2.0
   */

  /**
   * Constructs a new <code>LinksGetChannelCatalogMarketplaceSettingsLink</code>.
   * @alias module:model/LinksGetChannelCatalogMarketplaceSettingsLink
   * @class
  ...
  /**
   * Constructs a <code>LinksGetChannelCatalogMarketplaceSettingsLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinksGetChannelCatalogMarketplaceSettingsLink} obj Optional instance to populate.
   * @return {module:model/LinksGetChannelCatalogMarketplaceSettingsLink} The populated <code>LinksGetChannelCatalogMarketplaceSettingsLink</code> instance.
   */
